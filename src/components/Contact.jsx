      ...
      >
        <div className="flex justify-between items-center mb-4">
          ...
          >
            ...
            <span className="font-medium">+91 7733947327</span>
            <br></br>
            <span className="font-medium">harikesh2343@gmail.com</span>
          </a>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Harikesh Kashyap, love the website! I'd like to chat about some opportunities you might like! 🎉"
