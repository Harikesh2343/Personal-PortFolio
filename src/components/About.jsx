        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/harikeshkashyap2343/", "_blank")}
            >
              LinkedIn
            </motion.button>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/Harikesh2343?tab=repositories", "_blank")}
            >
              GitHub
            </motion.button>
          </div>
        ...
        <motion.div variants={fadeIn("left", "spring", 0.5, 0.75)} className="w-full md:w-2/3">
          ...
          >
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.1, 0.75)}>
              ...
              <span>
                I&apos;m a Full Stack Developer With Hands On Experience On Web Technologies
              </span>
            </motion.li>
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
              <span>
                Currently persuing Bachelor of Science and Technology in Computer Science at Lovely Professional University,
                I&apos;m all about building reliable, scalable Websites that makes a difference.
              </span>
            </motion.li>
